...
function App() {
  ...
  const actors = ['Sakib', 'Shoriful Raj', 'Jasim', 'Rubel', 'Salman Sah'];
...
function Person() {
  const age = 25;
  const money = 20;
  const person = { name: 'shakib', age: 13 };
...
function Device(props) {
  // console.log(props);
  return <h2>This is Device: {props.name}-
    price: {props.price} </h2>
}
